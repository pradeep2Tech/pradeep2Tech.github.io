...
draft: false
description: "Visualization and dashboards — Prometheus, Loki, and Tempo integration."
tags: ["technology-playbook", "cloud-native", "grafana"]
...
**Grafana** — Visualization and dashboards — Prometheus, Loki, and Tempo integration.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Grafana)]
...
{{< interview-answer >}}
"I'd pick **Grafana** when the domain needs visualization and dashboards. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
