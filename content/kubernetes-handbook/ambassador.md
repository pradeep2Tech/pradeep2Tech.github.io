---
title: "Ambassador (Emissary)"
date: 2026-06-30T10:00:00+00:00
draft: false
description: "Kubernetes-native API gateway built on Envoy."
tags: ["technology-playbook", "cloud-native", "ambassador"]
...
**Ambassador (Emissary)** — Kubernetes-native API gateway built on Envoy.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Ambassador)]
...
{{< interview-answer >}}
"I'd pick **Ambassador** when the domain needs reliable async integration. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
