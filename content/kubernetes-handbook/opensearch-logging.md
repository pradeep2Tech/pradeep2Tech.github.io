---
title: "OpenSearch for Logging"
date: 2026-06-30T10:00:00+00:00
draft: false
description: "Open-source logging stack alternative to ELK."
tags: ["technology-playbook", "cloud-native", "opensearch"]
categories: ["Technology Playbook"]
shortTitle: "OpenSearch Logs"
module: 6
...
**OpenSearch for Logging** — Open-source logging stack alternative to ELK.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(OpenSearch Logs)]
...
{{< interview-answer >}}
"I'd pick **OpenSearch Logs** when the domain needs reliable async integration. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
