...
draft: false
description: "Enterprise Kubernetes — built-in CI/CD, routes, and operator ecosystem."
tags: ["technology-playbook", "cloud-native", "openshift"]
...
**Red Hat OpenShift** — Enterprise Kubernetes — built-in CI/CD, routes, and operator ecosystem.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(OpenShift)]
...
{{< interview-answer >}}
"I'd pick **OpenShift** when the domain needs enterprise kubernetes. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
