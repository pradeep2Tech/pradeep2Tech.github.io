...
draft: false
description: "Metrics collection and alerting — pull model, PromQL, CNCF standard."
tags: ["technology-playbook", "cloud-native", "prometheus"]
...
**Prometheus** — Metrics collection and alerting — pull model, PromQL, CNCF standard.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Prometheus)]
...
{{< interview-answer >}}
"I'd pick **Prometheus** when the domain needs metrics collection and alerting. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
