...
draft: false
description: "Lightweight tracing — simple span collection and UI."
tags: ["technology-playbook", "cloud-native", "zipkin"]
...
**Zipkin** — Lightweight tracing — simple span collection and UI.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Zipkin)]
...
{{< interview-answer >}}
"I'd pick **Zipkin** when the domain needs lightweight tracing. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
