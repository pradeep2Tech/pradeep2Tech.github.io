...
draft: false
description: "Full-featured service mesh — traffic management, security, and telemetry."
tags: ["technology-playbook", "cloud-native", "istio"]
...
**Istio** — Full-featured service mesh — traffic management, security, and telemetry.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Istio)]
...
{{< interview-answer >}}
"I'd pick **Istio** when the domain needs full-featured service mesh. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
