...
draft: false
description: "Java batch framework — chunked processing integrated with Spring Boot."
tags: ["technology-playbook", "batch", "spring"]
...
**Spring Batch** — Java batch framework — chunked processing integrated with Spring Boot.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Spring Batch)]
...
{{< interview-answer >}}
"I'd pick **Spring Batch** when the domain needs java batch framework. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
