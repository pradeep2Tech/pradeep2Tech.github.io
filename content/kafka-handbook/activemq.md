...
draft: false
description: "JMS broker — Java enterprise integration and legacy bridge."
tags: ["technology-playbook", "messaging", "activemq"]
...
**Apache ActiveMQ** — JMS broker — Java enterprise integration and legacy bridge.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(ActiveMQ)]
...
{{< interview-answer >}}
"I'd pick **ActiveMQ** when the domain needs jms broker. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
