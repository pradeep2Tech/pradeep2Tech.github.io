...
draft: false
description: "Enterprise queues and topics — sessions, dead-letter, and transactions."
tags: ["technology-playbook", "messaging", "azure"]
categories: ["Technology Playbook"]
shortTitle: "Service Bus"
module: 4
moduleTitle: "Messaging & Streaming"
sectionRef: "4.10"
weight: 409
ShowToc: true
---
...
**Azure Service Bus** — Enterprise queues and topics — sessions, dead-letter, and transactions.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Service Bus)]
...
{{< interview-answer >}}
"I'd pick **Service Bus** when the domain needs enterprise queues and topics. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
