...
draft: false
description: "Distributed commit log — high-throughput event streaming and replay."
tags: ["technology-playbook", "messaging", "kafka"]
...
**Apache Kafka** — Distributed commit log — high-throughput event streaming and replay.
...
{{< interview-answer >}}
"I'd pick **Kafka** when the domain needs distributed commit log. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
