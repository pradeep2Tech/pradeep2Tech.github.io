...
draft: false
description: "Flexible AMQP broker — routing, priority queues, and classic enterprise messaging."
tags: ["technology-playbook", "messaging", "rabbitmq"]
...
**RabbitMQ** — Flexible AMQP broker — routing, priority queues, and classic enterprise messaging.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(RabbitMQ)]
...
{{< interview-answer >}}
"I'd pick **RabbitMQ** when the domain needs flexible amqp broker. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
