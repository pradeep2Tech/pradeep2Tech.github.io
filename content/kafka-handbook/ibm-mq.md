...
draft: false
description: "Mission-critical mainframe-era messaging — guaranteed delivery in BFSI."
tags: ["technology-playbook", "messaging", "ibm"]
...
**IBM MQ** — Mission-critical mainframe-era messaging — guaranteed delivery in BFSI.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(IBM MQ)]
...
{{< interview-answer >}}
"I'd pick **IBM MQ** when the domain needs mission-critical mainframe-era messaging. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
