...
draft: false
description: "Vector database with hybrid search — vectors + keywords + GraphQL API."
tags: ["technology-playbook", "database", "weaviate"]
...
**Weaviate** is a **vector** store. Vector database with hybrid search — vectors + keywords + GraphQL API.

---

## 2. What Problem It Solves

| Scenario | Why Weaviate |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | Weaviate strength | Watch out for |
| :--- | :--- | :--- |
