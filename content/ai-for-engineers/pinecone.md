...
draft: false
description: "Managed vector index — low-latency semantic search without infra tuning."
tags: ["technology-playbook", "database", "pinecone"]
...
**Pinecone** is a **vector** store. Managed vector index — low-latency semantic search without infra tuning.

---

## 2. What Problem It Solves

| Scenario | Why Pinecone |
| :--- | :--- |
| Primary application datastore | Embedding similarity, semantic search, RAG retrieval, and recommendation vectors |
...
- Access patterns align with **vector** strengths (embedding similarity, semantic search, rag retrieval, and recommendation vectors)
...
| :--- | :--- |
| **Same class** | See [Databases module](/technology-playbook/) for peers in vector |
...
{{< comparison-table >}}
| Dimension | Pinecone strength | Watch out for |
| :--- | :--- | :--- |
| **Data model** | Optimized for vector access paths | Misfit patterns cause performance cliffs |
