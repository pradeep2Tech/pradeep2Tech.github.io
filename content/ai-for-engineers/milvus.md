...
draft: false
description: "Open-source vector database — similarity search for RAG and recommendations."
tags: ["technology-playbook", "database", "milvus"]
...
**Milvus** is a **vector** store. Open-source vector database — similarity search for RAG and recommendations.
...
{{< comparison-table >}}
| Dimension | Milvus strength | Watch out for |
| :--- | :--- | :--- |
