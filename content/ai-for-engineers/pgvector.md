...
draft: false
description: "Vector extension for PostgreSQL — combine relational + embeddings in one DB."
tags: ["technology-playbook", "database", "pgvector"]
...
**pgvector** is a **vector** store. Vector extension for PostgreSQL — combine relational + embeddings in one DB.
...
{{< comparison-table >}}
| Dimension | pgvector strength | Watch out for |
| :--- | :--- | :--- |
