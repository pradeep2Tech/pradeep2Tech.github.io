...
draft: false
description: "Redis handbook covering fundamentals, internals, operations, comparisons, and interview preparation."
...
| :--- | :--- | :--- |
| Senior Engineer | [Senior Engineer Path](/redis-cheatsheet/09-learning-paths/redis-senior-engineer-path/) | Core types, internals, and production readiness |
| Technical Lead | [Lead Path](/redis-cheatsheet/09-learning-paths/redis-lead-path/) | Reliability, scaling, and incident governance |
| Architect | [Architect Path](/redis-cheatsheet/09-learning-paths/redis-architect-path/) | ADR-grade design and technology tradeoffs |
| Interview Prep | [Interview Revision Path](/redis-cheatsheet/09-learning-paths/redis-interview-revision-path/) | High-signal revision + Top 150 |
