...
draft: false
description: "Horizontal write scaling — shard key hashing, scatter-gather penalties, hot-shard skew, consistent hashing with virtual nodes, and Vitess/Citus routing."
tags: ["microservices", "sharding", "horizontal-partitioning", "consistent-hashing", "vitess"]
...
#### Runtime Execution Path & Hashing Algorithmic Routes
...
```text
  Shard key selection checklist:
    ...
    ✗ Never shard by status, country, or boolean flags alone
```
