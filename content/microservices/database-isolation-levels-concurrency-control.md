...
draft: false
description: "MVCC isolation tiers — dirty/non-repeatable/phantom read anomalies, optimistic version columns vs SELECT FOR UPDATE, and distributed deadlock risks."
tags: ["microservices", "isolation-levels", "mvcc", "optimistic-locking", "pessimistic-locking", "transactions"]
categories: ["Distributed Microservices"]
shortTitle: "Isolation Levels & Concurrency"
module: 3
...
#### Runtime Execution Path & Isolation Levels
