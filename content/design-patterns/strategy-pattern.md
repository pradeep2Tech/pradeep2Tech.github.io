...
| Behavior is tied to object lifecycle state transitions | No | Prefer [State Pattern](/design-patterns/state-pattern/) |
...
- **Pairs with:** [Factory Method](/design-patterns/factory-method-pattern/), [Open-Closed](/design-patterns/open-closed-principle/), [DI](/design-patterns/dependency-injection-inversion-of-control/)
