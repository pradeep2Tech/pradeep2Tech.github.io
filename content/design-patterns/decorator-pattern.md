...
| Behavior changes object identity semantics (authorization gate) | No | Prefer [Proxy](/design-patterns/proxy-pattern/) |
| Splitting abstraction from platform implementation | No | Prefer [Bridge](/design-patterns/bridge-pattern/) |
...
5. When does a decorator chain become a [Chain of Responsibility](/design-patterns/chain-of-responsibility-pattern/)?
...
- **Pairs with:** [Open-Closed](/design-patterns/open-closed-principle/), [Proxy](/design-patterns/proxy-pattern/), [Decorator vs Proxy vs Bridge](/design-patterns/decorator-vs-proxy-vs-bridge/)
...
- [In-Memory Rate Limiter LLD](/design-patterns/in-memory-rate-limiter-lld/) — layered request handling
