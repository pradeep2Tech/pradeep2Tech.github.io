...
shortTitle: "Decorator vs Proxy vs Bridge"
module: 7
...
| Need different interface than wrapped object | No | No | No | Use [Adapter](/design-patterns/adapter-pattern/) |
...
2. How does [Circuit Breaker](/design-patterns/proxy-pattern/) relate to Proxy? Where would you place metrics?
...
7. Remote Proxy + failure handling — what belongs in proxy vs [Facade](/design-patterns/facade-pattern/)?

---

### Revision Cheat Sheet

- **Decorator:** "Same interface, extra behavior, stackable." Smell: cross-cutting concerns duplicated at every call site. Pairs with [Decorator Pattern](/design-patterns/decorator-pattern/), [Open-Closed](/design-patterns/open-closed-principle/).
- **Proxy:** "Same interface, control access." Smell: expensive init, remote object, security gate. Pairs with [Proxy Pattern](/design-patterns/proxy-pattern/), lazy loading, circuit breaker.
- **Bridge:** "Two dimensions vary independently." Smell: cartesian product of subclasses (`EmailTwilio`, `EmailSmtp`, `SmsTwilio`…). Pairs with [Bridge Pattern](/design-patterns/bridge-pattern/).
...
- [Bridge Pattern](/design-patterns/bridge-pattern/)
...
- [In-Memory Rate Limiter LLD](/design-patterns/in-memory-rate-limiter-lld/) — Proxy-like gating
