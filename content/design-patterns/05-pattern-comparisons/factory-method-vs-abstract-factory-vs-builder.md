...
- Factory Method as a **static util** `create(String type)` with giant switch — no extension point ([Open-Closed](/design-patterns/01-solid-principles/open-closed-principle/) violation)
- Builder without **`build()` validation** — invalid objects leak into domain
- Confusing Abstract Factory with [Factory Method](/design-patterns/02-creational-patterns/factory-method-pattern/) because both have "factory" in the name
...
- **Factory Method:** "One product, creation deferred to provider/subclass." Smell: `new Concrete()` + `switch` in business code. Pairs with [Factory Method](/design-patterns/02-creational-patterns/factory-method-pattern/), [DI](/design-patterns/06-architectural-principles/dependency-injection-inversion-of-control/).
- **Abstract Factory:** "Bundle of related products, swap the bundle." Smell: risk of mixing incompatible concretes. Pairs with [Abstract Factory](/design-patterns/02-creational-patterns/abstract-factory-pattern/).
- **Builder:** "Step-by-step; validate at end." Smell: telescoping constructors or 10-arg `new`. Pairs with [Builder](/design-patterns/02-creational-patterns/builder-pattern/), immutable domain models.
...
- [Singleton Pattern](/design-patterns/02-creational-patterns/singleton-pattern/)
...
- [Notification Service LLD](/design-patterns/08-lld-case-studies/notification-system/) — factories in practice
