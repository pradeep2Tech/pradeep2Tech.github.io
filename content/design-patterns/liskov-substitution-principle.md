...
shortTitle: "Liskov Substitution Principle"
module: 1
...
| **Complexity** | May require splitting one fat base type into role-specific interfaces (see [ISP](/design-patterns/interface-segregation-principle/)) |
...
4. How does LSP relate to the [Interface Segregation Principle](/design-patterns/interface-segregation-principle/) for read-only views?
...
- **Pairs with:** [Interface Segregation](/design-patterns/interface-segregation-principle/), [Composition over inheritance](/design-patterns/solid-principles-composition-guide/)
