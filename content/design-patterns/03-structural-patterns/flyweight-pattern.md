...
| You need transparent caching of expensive remote calls | No | Prefer [Proxy](/design-patterns/03-structural-patterns/proxy-pattern/) |
...
- Confusing Flyweight factory pool with [Proxy](/design-patterns/03-structural-patterns/proxy-pattern/) cache — flyweight shares **identity**; proxy wraps **one** expensive subject
...
- **Pairs with:** [Proxy](/design-patterns/03-structural-patterns/proxy-pattern/), [Factory Method](/design-patterns/02-creational-patterns/factory-method-pattern/), [Singleton](/design-patterns/02-creational-patterns/singleton-pattern/) (pool as single registry)
