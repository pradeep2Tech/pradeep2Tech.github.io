...
| Stack optional cross-cutting features in any order | No | Prefer [Decorator](/design-patterns/03-structural-patterns/decorator-pattern/) |
| Translate incompatible third-party interfaces | No | Prefer [Adapter](/design-patterns/03-structural-patterns/adapter-pattern/) |
...
- **Pairs with:** [Decorator](/design-patterns/03-structural-patterns/decorator-pattern/), [Flyweight](/design-patterns/03-structural-patterns/flyweight-pattern/), [Decorator vs Proxy vs Bridge](/design-patterns/05-pattern-comparisons/decorator-vs-proxy-vs-bridge/)
...
- [In-Memory Rate Limiter LLD](/design-patterns/08-lld-case-studies/rate-limiter/) — access control proxy
