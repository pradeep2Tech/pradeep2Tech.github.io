...
| You need to add behavior around calls (logging, cache) | No | Prefer [Decorator](/design-patterns/03-structural-patterns/decorator-pattern/) or [Proxy](/design-patterns/03-structural-patterns/proxy-pattern/) |
...
- **Pairs with:** [Dependency Inversion](/design-patterns/01-solid-principles/dependency-inversion-principle/), [Facade](/design-patterns/03-structural-patterns/facade-pattern/), [Repository](/design-patterns/06-architectural-principles/repository-and-unit-of-work/)
...
- [Notification Service LLD](/design-patterns/08-lld-case-studies/notification-system/) — channel adapters in practice
