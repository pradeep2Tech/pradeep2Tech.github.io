...
| Bidirectional peer-to-peer updates between many objects | No | Prefer [Mediator Pattern](/design-patterns/mediator-pattern/) |
...
- **Pairs with:** [Mediator](/design-patterns/mediator-pattern/), [Command](/design-patterns/command-pattern/), [Notification Service LLD](/design-patterns/notification-service-lld/)
