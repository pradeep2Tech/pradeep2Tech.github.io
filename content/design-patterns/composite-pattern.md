...
| Deep trees with heavy cross-cutting concerns per node | Maybe | Consider [Visitor](/design-patterns/visitor-pattern/) for operations that vary |
...
- Confusing Composite with [Decorator](/design-patterns/decorator-pattern/) — composite **owns** children; decorator **wraps** one inner
...
4. When would you use [Visitor](/design-patterns/visitor-pattern/) instead of methods on the composite?
...
- **Pairs with:** [Iterator](/design-patterns/iterator-pattern/), [Visitor](/design-patterns/visitor-pattern/), [Composite organizational models](/design-patterns/domain-driven-design-building-blocks/)
...
- [Elevator Control System LLD](/design-patterns/elevator-control-system-lld/) — floor/button hierarchies
