...
| Simple one-to-one callback between two objects | No | Direct reference or [Observer](/design-patterns/04-behavioral-patterns/observer-pattern/) |
...
4. How does Mediator relate to [Facade](/design-patterns/03-structural-patterns/facade-pattern/) — similar or opposite?
...
- **Pairs with:** [Observer Pattern](/design-patterns/04-behavioral-patterns/observer-pattern/), [Facade Pattern](/design-patterns/03-structural-patterns/facade-pattern/)
