...
| Command objects would be huge snapshots of entire app state | No | Reconsider granularity or use [Memento](/design-patterns/04-behavioral-patterns/memento-pattern/) |
...
- **Pairs with:** [Memento](/design-patterns/04-behavioral-patterns/memento-pattern/), [Chain of Responsibility](/design-patterns/04-behavioral-patterns/chain-of-responsibility-pattern/), [Task Scheduler LLD](/design-patterns/08-lld-case-studies/task-scheduler-lld/)
...
- [Memento Pattern](/design-patterns/04-behavioral-patterns/memento-pattern/)
