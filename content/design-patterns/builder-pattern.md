...
| You need interchangeable **families** of products | No | Prefer [Abstract Factory](/design-patterns/abstract-factory-pattern/) |
| Deep copying from an existing instance is the goal | No | Prefer [Prototype](/design-patterns/prototype-pattern/) |
...
- **Pairs with:** [Factory Method](/design-patterns/factory-method-pattern/), [Prototype](/design-patterns/prototype-pattern/), immutable value objects
...
- [DTO, Entity & Mapper Separation](/design-patterns/dto-entity-mapper-separation/)
