...
shortTitle: "Strategy vs State vs Template"
module: 7
...
| Need runtime stacking of behaviors | No | No | No | Prefer [Decorator](/design-patterns/decorator-pattern/) |
...
3. **Shipping + tax + discount** in one checkout call — one pattern or three? Where does [Chain of Responsibility](/design-patterns/chain-of-responsibility-pattern/) fit?
...
- **Strategy:** "Pick algorithm from outside." Smell: `switch (mode)` on same operation. Pairs with [Factory Method](/design-patterns/factory-method-pattern/), [Open-Closed](/design-patterns/open-closed-principle/).
- **State:** "Object behaves differently by lifecycle phase." Smell: `if (status == …)` scattered across methods. Pairs with [State Pattern](/design-patterns/state-pattern/) deep dive.
- **Template Method:** "Same recipe, different ingredients." Smell: copy-pasted workflow differing in one step. Pairs with [Template Method](/design-patterns/template-method-pattern/).
...
- [Template Method Pattern](/design-patterns/template-method-pattern/)
...
- [Elevator Control System LLD](/design-patterns/elevator-control-system-lld/) — State in practice
- [Parking Lot System LLD](/design-patterns/parking-lot-system-lld/) — Strategy for pricing
