...
draft: false
description: "Distributed search and analytics — full-text, aggregations, and ELK stack core."
tags: ["technology-playbook", "database", "elasticsearch"]
...
**Elasticsearch** is a **search** store. Distributed search and analytics — full-text, aggregations, and ELK stack core.

---

## 2. What Problem It Solves

| Scenario | Why Elasticsearch |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | Elasticsearch strength | Watch out for |
| :--- | :--- | :--- |
