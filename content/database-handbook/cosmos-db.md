...
draft: false
description: "Multi-model global database — SLA-backed latency and turnkey geo-replication."
tags: ["technology-playbook", "database", "cosmos"]
...
**Azure Cosmos DB** is a **document** store. Multi-model global database — SLA-backed latency and turnkey geo-replication.
...
{{< comparison-table >}}
| Dimension | Cosmos DB strength | Watch out for |
| :--- | :--- | :--- |
