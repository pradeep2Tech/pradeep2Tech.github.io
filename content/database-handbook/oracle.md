...
draft: false
description: "Enterprise RDBMS — RAC, partitioning, and deep ERP/finance footprint."
tags: ["technology-playbook", "database", "oracle"]
...
**Oracle Database** is a **relational** store. Enterprise RDBMS — RAC, partitioning, and deep ERP/finance footprint.
...
{{< comparison-table >}}
| Dimension | Oracle strength | Watch out for |
| :--- | :--- | :--- |
