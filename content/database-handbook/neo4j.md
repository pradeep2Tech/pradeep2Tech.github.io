...
draft: false
description: "Native property graph — fraud rings, recommendations, and knowledge graphs."
tags: ["technology-playbook", "database", "neo4j"]
...
**Neo4j** is a **graph** store. Native property graph — fraud rings, recommendations, and knowledge graphs.
...
{{< comparison-table >}}
| Dimension | Neo4j strength | Watch out for |
| :--- | :--- | :--- |
