...
draft: false
description: "Columnar OLAP — fast analytical queries on billions of rows."
tags: ["technology-playbook", "database", "clickhouse"]
...
**ClickHouse** is a **analytics** store. Columnar OLAP — fast analytical queries on billions of rows.

---

## 2. What Problem It Solves

| Scenario | Why ClickHouse |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | ClickHouse strength | Watch out for |
| :--- | :--- | :--- |
