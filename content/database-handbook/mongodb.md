...
draft: false
description: "Document database with flexible schema — rapid product iteration and horizontal scale."
tags: ["technology-playbook", "database", "mongodb"]
...
**MongoDB** is a **document** store. Document database with flexible schema — rapid product iteration and horizontal scale.
...
| :--- | :--- |
| Primary application datastore | Flexible schema, nested JSON documents, horizontal scale for product catalogs |
...
- Access patterns align with **document** strengths (flexible schema, nested json documents, horizontal scale for product catalogs)
...
| :--- | :--- |
| **Same class** | See [Databases module](/technology-playbook/) for peers in document |
...
{{< comparison-table >}}
| Dimension | MongoDB strength | Watch out for |
| :--- | :--- | :--- |
| **Data model** | Optimized for document access paths | Misfit patterns cause performance cliffs |
...
{{< interview-answer >}}
"For **MongoDB**, I'd choose it when workloads need flexible schema, nested json documents, horizontal scale for product catalogs and the team can operate it responsibly. I'd compare it against other **document** options on ops burden, licensing, and cloud managed offerings. I'd also state what I would **not** store there — for example heavy analytics on OLTP or graph traversals on plain relational without extension."
{{< /interview-answer >}}
