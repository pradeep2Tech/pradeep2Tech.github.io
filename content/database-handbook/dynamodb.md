...
draft: false
description: "Managed key-value/document — predictable scale, pay-per-request, global tables."
tags: ["technology-playbook", "database", "dynamodb"]
...
**Amazon DynamoDB** is a **key value** store. Managed key-value/document — predictable scale, pay-per-request, global tables.
...
{{< comparison-table >}}
| Dimension | DynamoDB strength | Watch out for |
| :--- | :--- | :--- |
