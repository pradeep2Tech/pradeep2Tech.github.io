...
draft: false
description: "Managed graph — Gremlin and SPARQL for AWS-native graph workloads."
tags: ["technology-playbook", "database", "amazon"]
...
**Amazon Neptune** is a **graph** store. Managed graph — Gremlin and SPARQL for AWS-native graph workloads.

---

## 2. What Problem It Solves

| Scenario | Why Neptune |
| :--- | :--- |
| Primary application datastore | Relationship traversal — fraud, social, knowledge graphs, dependency maps |
...
- Access patterns align with **graph** strengths (relationship traversal — fraud, social, knowledge graphs, dependency maps)
...
| :--- | :--- |
| **Same class** | See [Databases module](/technology-playbook/) for peers in graph |
...
{{< comparison-table >}}
| Dimension | Neptune strength | Watch out for |
| :--- | :--- | :--- |
| **Data model** | Optimized for graph access paths | Misfit patterns cause performance cliffs |
...
{{< interview-answer >}}
"For **Amazon Neptune**, I'd choose it when workloads need relationship traversal — fraud, social, knowledge graphs, dependency maps and the team can operate it responsibly. I'd compare it against other **graph** options on ops burden, licensing, and cloud managed offerings. I'd also state what I would **not** store there — for example heavy analytics on OLTP or graph traversals on plain relational without extension."
{{< /interview-answer >}}
