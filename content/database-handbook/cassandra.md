...
draft: false
description: "Wide-column store for write-heavy, always-on workloads at planet scale."
tags: ["technology-playbook", "database", "cassandra"]
...
**Apache Cassandra** is a **wide column** store. Wide-column store for write-heavy, always-on workloads at planet scale.

---

## 2. What Problem It Solves

| Scenario | Why Cassandra |
| :--- | :--- |
| Primary application datastore | Write-heavy, partition-tolerant, time-series and IoT at massive scale |
...
- Access patterns align with **wide-column** strengths (write-heavy, partition-tolerant, time-series and iot at massive scale)
...
| :--- | :--- |
| **Same class** | See [Databases module](/technology-playbook/) for peers in wide-column |
...
{{< comparison-table >}}
| Dimension | Cassandra strength | Watch out for |
| :--- | :--- | :--- |
| **Data model** | Optimized for wide-column access paths | Misfit patterns cause performance cliffs |
...
{{< interview-answer >}}
"For **Apache Cassandra**, I'd choose it when workloads need write-heavy, partition-tolerant, time-series and iot at massive scale and the team can operate it responsibly. I'd compare it against other **wide-column** options on ops burden, licensing, and cloud managed offerings. I'd also state what I would **not** store there — for example heavy analytics on OLTP or graph traversals on plain relational without extension."
{{< /interview-answer >}}
