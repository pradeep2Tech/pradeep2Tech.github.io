...
draft: false
description: "Serverless analytics warehouse — petabyte scale SQL with minimal ops."
tags: ["technology-playbook", "database", "bigquery"]
...
**Google BigQuery** is a **analytics** store. Serverless analytics warehouse — petabyte scale SQL with minimal ops.

---

## 2. What Problem It Solves

| Scenario | Why BigQuery |
| :--- | :--- |
| Primary application datastore | Columnar scans, aggregations, BI dashboards, and petabyte warehouses |
...
- Access patterns align with **analytics** strengths (columnar scans, aggregations, bi dashboards, and petabyte warehouses)
...
| :--- | :--- |
| **Same class** | See [Databases module](/technology-playbook/) for peers in analytics |
...
{{< comparison-table >}}
| Dimension | BigQuery strength | Watch out for |
| :--- | :--- | :--- |
| **Data model** | Optimized for analytics access paths | Misfit patterns cause performance cliffs |
...
{{< interview-answer >}}
"For **Google BigQuery**, I'd choose it when workloads need columnar scans, aggregations, bi dashboards, and petabyte warehouses and the team can operate it responsibly. I'd compare it against other **analytics** options on ops burden, licensing, and cloud managed offerings. I'd also state what I would **not** store there — for example heavy analytics on OLTP or graph traversals on plain relational without extension."
{{< /interview-answer >}}
