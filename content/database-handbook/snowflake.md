...
draft: false
description: "Cloud data warehouse — separation of storage and compute, SQL analytics."
tags: ["technology-playbook", "database", "snowflake"]
...
**Snowflake** is a **analytics** store. Cloud data warehouse — separation of storage and compute, SQL analytics.

---

## 2. What Problem It Solves

| Scenario | Why Snowflake |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | Snowflake strength | Watch out for |
| :--- | :--- | :--- |
