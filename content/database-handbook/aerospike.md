...
draft: false
description: "Flash-optimized key-value — sub-ms reads for ad-tech and fraud scoring."
tags: ["technology-playbook", "database", "aerospike"]
categories: ["Technology Playbook"]
shortTitle: "Aerospike"
module: 3
...
**Aerospike** is a **key value** store. Flash-optimized key-value — sub-ms reads for ad-tech and fraud scoring.

---

## 2. What Problem It Solves

| Scenario | Why Aerospike |
| :--- | :--- |
| Primary application datastore | Sub-millisecond lookups, caching, session store, and simple access patterns |
...
- Access patterns align with **key-value** strengths (sub-millisecond lookups, caching, session store, and simple access patterns)
...
| :--- | :--- |
| **Same class** | See [Databases module](/technology-playbook/) for peers in key-value |
...
{{< comparison-table >}}
| Dimension | Aerospike strength | Watch out for |
| :--- | :--- | :--- |
| **Data model** | Optimized for key-value access paths | Misfit patterns cause performance cliffs |
...
{{< interview-answer >}}
"For **Aerospike**, I'd choose it when workloads need sub-millisecond lookups, caching, session store, and simple access patterns and the team can operate it responsibly. I'd compare it against other **key-value** options on ops burden, licensing, and cloud managed offerings. I'd also state what I would **not** store there — for example heavy analytics on OLTP or graph traversals on plain relational without extension."
{{< /interview-answer >}}
