...
draft: false
description: "Elasticsearch fork — open-source search with AWS OpenSearch Service."
tags: ["technology-playbook", "database", "opensearch"]
...
**OpenSearch** is a **search** store. Elasticsearch fork — open-source search with AWS OpenSearch Service.
...
{{< comparison-table >}}
| Dimension | OpenSearch strength | Watch out for |
| :--- | :--- | :--- |
