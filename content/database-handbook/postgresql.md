...
draft: false
description: "Open-source relational database with JSON, extensions, and strong ACID."
tags: ["technology-playbook", "database", "postgresql"]
...
**PostgreSQL** is a **relational** store. Open-source relational database with JSON, extensions, and strong ACID.
...
{{< comparison-table >}}
| Dimension | PostgreSQL strength | Watch out for |
| :--- | :--- | :--- |
