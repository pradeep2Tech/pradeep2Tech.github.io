...
draft: false
description: "Cassandra-compatible with C++ performance — lower tail latency."
tags: ["technology-playbook", "database", "scylladb"]
...
**ScyllaDB** is a **wide column** store. Cassandra-compatible with C++ performance — lower tail latency.
...
{{< comparison-table >}}
| Dimension | ScyllaDB strength | Watch out for |
| :--- | :--- | :--- |
