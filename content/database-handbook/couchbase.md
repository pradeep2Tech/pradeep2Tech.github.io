...
draft: false
description: "Document + key-value with SQL++ — mobile sync and sub-millisecond reads."
tags: ["technology-playbook", "database", "couchbase"]
...
**Couchbase** is a **document** store. Document + key-value with SQL++ — mobile sync and sub-millisecond reads.

---

## 2. What Problem It Solves

| Scenario | Why Couchbase |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | Couchbase strength | Watch out for |
| :--- | :--- | :--- |
