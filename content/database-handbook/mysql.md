...
draft: false
description: "Widely deployed OLTP relational database — simple ops, read replicas, InnoDB."
tags: ["technology-playbook", "database", "mysql"]
...
**MySQL** is a **relational** store. Widely deployed OLTP relational database — simple ops, read replicas, InnoDB.
...
{{< comparison-table >}}
| Dimension | MySQL strength | Watch out for |
| :--- | :--- | :--- |
