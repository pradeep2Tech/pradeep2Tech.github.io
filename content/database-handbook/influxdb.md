...
draft: false
description: "Time-series for metrics and IoT — retention policies and downsampling."
tags: ["technology-playbook", "database", "influxdb"]
...
**InfluxDB** is a **time series** store. Time-series for metrics and IoT — retention policies and downsampling.

---

## 2. What Problem It Solves

| Scenario | Why InfluxDB |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | InfluxDB strength | Watch out for |
| :--- | :--- | :--- |
