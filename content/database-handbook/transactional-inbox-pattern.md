...
| :--- | :--- | :--- |
| **Producer** | [Transactional Outbox](/database-handbook/transactional-outbox-pattern/) | Domain row + event row commit atomically |
| **Consumer** | Transactional Inbox | Duplicate events discarded via unique constraint |
| **Operations** | [Performance Tuning](/database-handbook/outbox-inbox-performance-tuning/) | Polling intervals, MVCC bloat, advisory locks |
