...
Historically, the auto-incremented `BIGINT` (8-byte integer) has served as the default surrogate key standard. Integers naturally align with CPU registers, sort rapidly, and pack efficiently into 8 KB page cells, maximizing [B+ Tree fan-out](/database-handbook/b-plus-tree-storage-mechanics/) parameters.
