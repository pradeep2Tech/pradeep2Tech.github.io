...
draft: false
description: "HBase-backed time-series — large-scale metrics on Hadoop stack."
tags: ["technology-playbook", "database", "opentsdb"]
...
**OpenTSDB** is a **time series** store. HBase-backed time-series — large-scale metrics on Hadoop stack.

---

## 2. What Problem It Solves

| Scenario | Why OpenTSDB |
| :--- | :--- |
...
{{< comparison-table >}}
| Dimension | OpenTSDB strength | Watch out for |
| :--- | :--- | :--- |
