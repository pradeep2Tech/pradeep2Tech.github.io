...
draft: false
description: "In-memory data structure store — cache, session, pub/sub, and lightweight queue."
tags: ["technology-playbook", "database", "redis"]
...
**Redis** is a **key value** store. In-memory data structure store — cache, session, pub/sub, and lightweight queue.
...
{{< comparison-table >}}
| Dimension | Redis strength | Watch out for |
| :--- | :--- | :--- |
