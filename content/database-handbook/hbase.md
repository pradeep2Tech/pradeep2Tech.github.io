...
draft: false
description: "Hadoop ecosystem wide-column store — strong consistency on HDFS."
tags: ["technology-playbook", "database", "hbase"]
...
**Apache HBase** is a **wide column** store. Hadoop ecosystem wide-column store — strong consistency on HDFS.
...
{{< comparison-table >}}
| Dimension | HBase strength | Watch out for |
| :--- | :--- | :--- |
