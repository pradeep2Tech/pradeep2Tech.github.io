...
draft: false
description: "Enterprise cloud — hybrid, Active Directory, and Microsoft stack integration."
tags: ["technology-playbook", "cloud", "azure"]
...
**Microsoft Azure** — Enterprise cloud — hybrid, Active Directory, and Microsoft stack integration.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Azure)]
...
{{< interview-answer >}}
"I'd pick **Azure** when the domain needs enterprise cloud. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
