...
draft: false
description: "Data and ML strength — BigQuery, GKE, and strong networking."
tags: ["technology-playbook", "cloud", "gcp"]
...
**Google Cloud Platform (GCP)** — Data and ML strength — BigQuery, GKE, and strong networking.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(GCP)]
...
{{< interview-answer >}}
"I'd pick **GCP** when the domain needs data and ml strength. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
