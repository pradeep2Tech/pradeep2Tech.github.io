...
draft: false
description: "Market leader cloud — broadest service catalog and ecosystem."
tags: ["technology-playbook", "cloud", "aws"]
...
**Amazon Web Services (AWS)** — Market leader cloud — broadest service catalog and ecosystem.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(AWS)]
...
{{< interview-answer >}}
"I'd pick **AWS** when the domain needs market leader cloud. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
