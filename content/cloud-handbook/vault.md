...
draft: false
description: "Dynamic secrets, encryption, and PKI — central secret lifecycle."
tags: ["technology-playbook", "cloud-native", "vault"]
...
**HashiCorp Vault** — Dynamic secrets, encryption, and PKI — central secret lifecycle.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Vault)]
...
{{< interview-answer >}}
"I'd pick **Vault** when the domain needs dynamic secrets, encryption, and pki. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
