...
draft: false
description: "Reliable event publishing from the database transaction — no dual-write inconsistency."
tags: ["technology-playbook", "architecture", "outbox"]
...
Reliable event publishing from the database transaction — no dual-write inconsistency. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
> **Deep dive:** For implementation patterns and code examples, see the companion post [/database-handbook/transactional-outbox-pattern/](/database-handbook/transactional-outbox-pattern/).
...
**Outbox** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
