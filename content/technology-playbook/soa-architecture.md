...
draft: false
description: "Enterprise service bus era integration — shared contracts, orchestration, and governance."
tags: ["technology-playbook", "architecture", "soa"]
...
Enterprise service bus era integration — shared contracts, orchestration, and governance. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
...
**SOA** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
