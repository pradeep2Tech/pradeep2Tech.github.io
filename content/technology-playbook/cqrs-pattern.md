...
draft: false
description: "Separate read and write models — optimize queries without polluting the transactional model."
tags: ["technology-playbook", "architecture", "cqrs"]
...
Separate read and write models — optimize queries without polluting the transactional model. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
> **Deep dive:** For implementation patterns and code examples, see the companion post [/microservices/cqrs-event-sourcing/](/microservices/cqrs-event-sourcing/).
...
**CQRS** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
