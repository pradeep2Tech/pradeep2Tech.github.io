...
draft: false
description: "Distributed transactions via compensating steps — coordinate long-running business flows."
tags: ["technology-playbook", "architecture", "saga"]
...
Distributed transactions via compensating steps — coordinate long-running business flows. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
> **Deep dive:** For implementation patterns and code examples, see the companion post [/microservices/saga-pattern-distributed-transactions/](/microservices/saga-pattern-distributed-transactions/).
...
**Saga** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
