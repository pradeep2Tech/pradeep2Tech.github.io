...
draft: false
description: "Co-locate cross-cutting concerns (proxy, logging, mTLS) in a companion container."
tags: ["technology-playbook", "architecture", "sidecar"]
...
Co-locate cross-cutting concerns (proxy, logging, mTLS) in a companion container. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
> **Deep dive:** For implementation patterns and code examples, see the companion post [/microservices/sidecar-integration-pattern/](/microservices/sidecar-integration-pattern/).
...
**Sidecar** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
