...
draft: false
description: "Incrementally replace legacy systems by routing traffic to new services over time."
tags: ["technology-playbook", "architecture", "strangler"]
...
Incrementally replace legacy systems by routing traffic to new services over time. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
> **Deep dive:** For implementation patterns and code examples, see the companion post [/microservices/strangler-fig-application-pattern/](/microservices/strangler-fig-application-pattern/).
...
**Strangler** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
