...
draft: false
description: "Kubernetes-native workflow engine — containerized step DAGs."
tags: ["technology-playbook", "workflow", "argo"]
categories: ["Technology Playbook"]
shortTitle: "Argo Workflows"
module: 5
...
**Argo Workflows** — Kubernetes-native workflow engine — containerized step DAGs.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Argo Workflows)]
...
{{< interview-answer >}}
"I'd pick **Argo Workflows** when the domain needs kubernetes-native workflow engine. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
