...
draft: false
description: "Modern data workflow orchestration — Python-first with observability."
tags: ["technology-playbook", "workflow", "prefect"]
...
**Prefect** — Modern data workflow orchestration — Python-first with observability.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Prefect)]
...
{{< interview-answer >}}
"I'd pick **Prefect** when the domain needs modern data workflow orchestration. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
