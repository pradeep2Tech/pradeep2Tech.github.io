...
draft: false
description: "Loose coupling via events and async consumers — scale write paths and decouple teams."
...
Loose coupling via events and async consumers — scale write paths and decouple teams. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
> **Deep dive:** For implementation patterns and code examples, see the companion post [/microservices/event-driven-architecture-log-streaming/](/microservices/event-driven-architecture-log-streaming/).
...
**Event-Driven** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
