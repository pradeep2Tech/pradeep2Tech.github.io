...
draft: false
description: "Distributed batch and micro-batch analytics — SQL, ML, and large ETL."
tags: ["technology-playbook", "batch", "apache"]
...
**Apache Spark** — Distributed batch and micro-batch analytics — SQL, ML, and large ETL.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Spark)]
...
{{< interview-answer >}}
"I'd pick **Spark** when the domain needs distributed batch and micro-batch analytics. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
