...
draft: false
description: "Single deployable unit with shared codebase and database — when simplicity beats distribution."
tags: ["technology-playbook", "architecture", "monolith"]
...
Single deployable unit with shared codebase and database — when simplicity beats distribution. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
...
**Monolith** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
