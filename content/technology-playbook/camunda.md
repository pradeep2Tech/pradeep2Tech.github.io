...
draft: false
description: "BPMN workflow engine — business process visibility and human workflows."
tags: ["technology-playbook", "workflow", "camunda"]
...
**Camunda** — BPMN workflow engine — business process visibility and human workflows.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Camunda)]
...
{{< interview-answer >}}
"I'd pick **Camunda** when the domain needs bpmn workflow engine. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
