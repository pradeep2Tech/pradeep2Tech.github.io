...
draft: false
description: "Excel-like decision tables compiled to Java — business-owned rules."
tags: ["technology-playbook", "rules", "openl"]
categories: ["Technology Playbook"]
shortTitle: "OpenL Tablets"
module: 5
...
**OpenL Tablets** — Excel-like decision tables compiled to Java — business-owned rules.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(OpenL Tablets)]
...
{{< interview-answer >}}
"I'd pick **OpenL Tablets** when the domain needs excel-like decision tables compiled to java. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
