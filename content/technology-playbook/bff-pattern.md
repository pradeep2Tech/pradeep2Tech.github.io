...
draft: false
description: "Tailored API per client channel — mobile, web, partner — without bloating core services."
tags: ["technology-playbook", "architecture", "bff"]
...
Tailored API per client channel — mobile, web, partner — without bloating core services. Use this page to decide **when** the pattern earns its complexity — not just what it means on a diagram.
...
**BFF** addresses a specific slice of these pains. Match the pattern to the pain — do not adopt it because a reference architecture diagram includes the box.
