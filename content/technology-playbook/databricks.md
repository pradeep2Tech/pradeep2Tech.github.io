...
draft: false
description: "Unified Spark platform — notebooks, Delta Lake, and ML lifecycle."
tags: ["technology-playbook", "batch", "databricks"]
...
**Databricks** — Unified Spark platform — notebooks, Delta Lake, and ML lifecycle.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Databricks)]
...
{{< interview-answer >}}
"I'd pick **Databricks** when the domain needs unified spark platform. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
