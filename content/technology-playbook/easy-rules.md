...
draft: false
description: "Lightweight Java rules — simple predicates without a full BRMS."
tags: ["technology-playbook", "rules", "easy"]
categories: ["Technology Playbook"]
shortTitle: "Easy Rules"
module: 5
...
**Easy Rules** — Lightweight Java rules — simple predicates without a full BRMS.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Easy Rules)]
...
{{< interview-answer >}}
"I'd pick **Easy Rules** when the domain needs lightweight java rules. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
