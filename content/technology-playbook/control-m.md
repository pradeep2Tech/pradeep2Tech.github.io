...
draft: false
description: "Enterprise workload automation — cross-system batch dependencies."
tags: ["technology-playbook", "scheduler", "control"]
categories: ["Technology Playbook"]
shortTitle: "Control-M"
module: 5
...
**Control-M** — Enterprise workload automation — cross-system batch dependencies.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Control-M)]
...
{{< interview-answer >}}
"I'd pick **Control-M** when the domain needs enterprise workload automation. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
