...
draft: false
description: "Durable workflow orchestration — sagas, timers, and human tasks with code."
tags: ["technology-playbook", "workflow", "temporal"]
...
**Temporal** — Durable workflow orchestration — sagas, timers, and human tasks with code.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Temporal)]
...
{{< interview-answer >}}
"I'd pick **Temporal** when the domain needs durable workflow orchestration. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
