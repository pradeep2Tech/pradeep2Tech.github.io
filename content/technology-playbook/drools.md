...
draft: false
description: "Java rule engine — DRL rules, decision tables, and BRMS integration."
tags: ["technology-playbook", "rules", "drools"]
...
**Drools** — Java rule engine — DRL rules, decision tables, and BRMS integration.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(Drools)]
...
{{< interview-answer >}}
"I'd pick **Drools** when the domain needs java rule engine. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
