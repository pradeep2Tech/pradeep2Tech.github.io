---
title: "AWS Event-Driven Rules"
date: 2026-06-30T10:00:00+00:00
draft: false
description: "EventBridge rules and Step Functions — cloud-native conditional routing."
tags: ["technology-playbook", "rules", "aws"]
categories: ["Technology Playbook"]
shortTitle: "AWS Rules"
module: 5
...
**AWS Event-Driven Rules** — EventBridge rules and Step Functions — cloud-native conditional routing.
...
```mermaid
flowchart LR
  producer[Order Service] --> broker[(AWS Rules)]
...
{{< interview-answer >}}
"I'd pick **AWS Rules** when the domain needs eventbridge rules and step functions. I clarify delivery guarantees, ordering needs, and ops model — managed cloud queue vs self-hosted Kafka. I always mention idempotent consumers and dead-letter handling."
{{< /interview-answer >}}
