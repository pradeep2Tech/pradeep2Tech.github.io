...
The Pager/VFS boundary is where SQLite's in-process design meets the host operating system — and where the journaling mechanics covered in [Two-Phase Commit Journaling](/database-internals/acid-two-phase-commit-journaling/) enforce durability at the physical block level.
