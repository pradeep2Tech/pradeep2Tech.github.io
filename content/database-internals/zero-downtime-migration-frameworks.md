...
| 5 | Validate [primary key](/database-internals/primary-key-selection-strategies/) and index design before backfill — rewriting 100M rows twice is expensive |
