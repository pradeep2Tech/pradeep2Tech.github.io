...
draft: true
description: "Reference equality (==) keys — not equals()."
...
_TODO: Explain **IdentityHashMap** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How IdentityHashMap helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: WeakHashMap](/java-engineering/weakhashmap/)
- [Next: PriorityQueue](/java-engineering/priorityqueue/)
