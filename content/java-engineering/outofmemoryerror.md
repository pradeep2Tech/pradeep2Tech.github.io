...
draft: true
description: "Heap, metaspace, and direct buffer OOM — diagnosis."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "OutOfMemoryError"
module: 9
...
_TODO: Explain **OutOfMemoryError** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How OutOfMemoryError helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Memory Leak](/java-engineering/memory-leak/)
- [Next: Escape Analysis](/java-engineering/escape-analysis/)
