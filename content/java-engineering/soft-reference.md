...
draft: true
description: "Collected under memory pressure — soft caches."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Soft Reference"
module: 9
...
_TODO: Explain **Soft Reference** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Soft Reference helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Weak Reference](/java-engineering/weak-reference/)
- [Next: Phantom Reference](/java-engineering/phantom-reference/)
