...
draft: true
description: "-Xmx, -Xms, GC flags, and diagnostic switches."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "JVM Parameters"
module: 10
...
_TODO: Explain **JVM Parameters** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How JVM Parameters helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: JVM Startup](/java-engineering/jvm-startup/)
- [Next: Perf Tuning](/java-engineering/performance-tuning-basics/)
