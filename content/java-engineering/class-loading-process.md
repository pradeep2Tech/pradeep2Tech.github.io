...
draft: true
description: "Loading, linking, initialization — when static blocks run."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Class Loading"
module: 10
...
_TODO: Explain **Class Loading Process** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Class Loading Process helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Class Loader](/java-engineering/class-loader/)
- [Next: Bytecode](/java-engineering/bytecode/)
