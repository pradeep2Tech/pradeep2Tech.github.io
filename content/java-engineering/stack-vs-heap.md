...
draft: true
description: "Thread stacks vs shared heap — where locals and objects live."
...
_TODO: Explain **Stack vs Heap** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Stack vs Heap helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Structured Concurrency](/java-engineering/structured-concurrency/)
- [Next: JVM Memory](/java-engineering/jvm-memory-layout/)
