...
draft: true
description: "JVM instruction set — opcodes, stack machine, and verification."
...
_TODO: Explain **Bytecode** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Bytecode helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Class Loading](/java-engineering/class-loading-process/)
- [Next: JIT Compiler](/java-engineering/jit-compiler/)
