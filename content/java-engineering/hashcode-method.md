...
draft: true
description: "Hash bucket distribution — contract with equals and collision handling."
...
_TODO: Explain **hashCode()** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How hashCode() helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: equals()](/java-engineering/equals-method/)
- [Next: toString()](/java-engineering/tostring-method/)
