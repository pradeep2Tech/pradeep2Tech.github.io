...
draft: true
description: "Domain-specific checked and unchecked exception design."
...
_TODO: Explain **Custom Exceptions** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Custom Exceptions helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: try-with-resources](/java-engineering/try-with-resources/)
- [Next: Exception Best Practices](/java-engineering/exception-handling-best-practices/)
