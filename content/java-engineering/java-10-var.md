...
draft: true
description: "Local variable type inference — limits and readability."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Java 10 var"
module: 11
...
_TODO: Explain **Java 10 — var** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Java 10 — var helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Java 9](/java-engineering/java-9-features/)
- [Next: Java 11](/java-engineering/java-11-features/)
