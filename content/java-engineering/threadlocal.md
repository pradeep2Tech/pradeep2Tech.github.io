...
draft: true
description: "Per-thread variable isolation — context propagation patterns."
...
_TODO: Explain **ThreadLocal** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How ThreadLocal helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Phaser](/java-engineering/phaser/)
- [Next: Virtual Threads](/java-engineering/virtual-threads/)
