...
draft: true
description: "? extends and ? super — PECS producer/consumer guidance."
...
_TODO: Explain **Wildcards** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Wildcards helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Generic Methods](/java-engineering/generic-methods/)
- [Next: Bounded Types](/java-engineering/bounded-types/)
