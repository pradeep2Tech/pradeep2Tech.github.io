...
draft: true
description: "Compile-time processors — APT and code generation."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Annotation Processing"
module: 13
moduleTitle: "Reflection & Annotations"
sectionRef: "13.4"
ShowToc: true
...
_TODO: Explain **Annotation Processing** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Annotation Processing helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Built-in Annotations](/java-engineering/built-in-annotations/)
- [Next: Serializable](/java-engineering/serializable/)
