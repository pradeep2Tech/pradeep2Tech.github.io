...
draft: true
description: "T apply(R) — one-argument transformation."
...
_TODO: Explain **Function** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Function helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Predicate](/java-engineering/predicate/)
- [Next: BiFunction](/java-engineering/bifunction/)
