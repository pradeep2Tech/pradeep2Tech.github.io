...
draft: true
description: "Declaration, parameters, varargs, overloading, and return semantics."
...
_TODO: Explain **Methods** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Methods helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Control Flow](/java-engineering/control-statements/)
- [Next: Arrays](/java-engineering/arrays/)
