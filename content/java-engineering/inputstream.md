...
draft: true
description: "Byte-oriented input — read, skip, mark/reset."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "InputStream"
module: 12
moduleTitle: "Java IO"
sectionRef: "12.4"
ShowToc: true
...
_TODO: Explain **InputStream** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How InputStream helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Files](/java-engineering/files/)
- [Next: OutputStream](/java-engineering/outputstream/)
