...
draft: true
description: "T get() — lazy value provision with no arguments."
...
_TODO: Explain **Supplier** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Supplier helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Optional](/java-engineering/optional/)
- [Next: Consumer](/java-engineering/consumer/)
