...
draft: true
description: "Default references — objects unreachable when no strong refs remain."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Strong Reference"
module: 9
...
_TODO: Explain **Strong Reference** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Strong Reference helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Reference Types](/java-engineering/reference-types/)
- [Next: Weak Reference](/java-engineering/weak-reference/)
