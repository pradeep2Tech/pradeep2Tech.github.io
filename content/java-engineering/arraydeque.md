...
draft: true
description: "Resizable array deque — efficient stack and queue without synchronization."
...
_TODO: Explain **ArrayDeque** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How ArrayDeque helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: PriorityQueue](/java-engineering/priorityqueue/)
- [Next: Collections](/java-engineering/collections-util/)
