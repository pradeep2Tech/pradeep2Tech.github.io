...
draft: true
description: "Concurrent reads, exclusive writes — ReentrantReadWriteLock."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "ReadWriteLock"
module: 8
...
_TODO: Explain **ReadWriteLock** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How ReadWriteLock helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Locks](/java-engineering/locks/)
- [Next: Semaphore](/java-engineering/semaphore/)
