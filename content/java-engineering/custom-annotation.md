...
draft: true
description: "Defining and documenting your own annotations."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Custom Annotation"
module: 13
...
_TODO: Explain **Custom Annotation** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Custom Annotation helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Reflection](/java-engineering/reflection-api/)
- [Next: Built-in Annotations](/java-engineering/built-in-annotations/)
