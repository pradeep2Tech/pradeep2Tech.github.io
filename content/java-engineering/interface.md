...
draft: true
description: "Contracts — default methods, static methods, and functional interfaces."
...
_TODO: Explain **Interface** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Interface helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Encapsulation](/java-engineering/encapsulation/)
- [Next: Abstract Class](/java-engineering/abstract-class/)
