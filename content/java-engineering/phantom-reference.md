...
draft: true
description: "Post-mortem cleanup — ReferenceQueue and cleaner patterns."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Phantom Reference"
module: 9
...
_TODO: Explain **Phantom Reference** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Phantom Reference helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Soft Reference](/java-engineering/soft-reference/)
- [Next: Memory Leak](/java-engineering/memory-leak/)
