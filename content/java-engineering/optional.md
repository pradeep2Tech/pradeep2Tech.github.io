...
draft: true
description: "Explicit absence container — avoid null in return types."
...
_TODO: Explain **Optional** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Optional helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Method Reference](/java-engineering/method-reference/)
- [Next: Supplier](/java-engineering/supplier/)
