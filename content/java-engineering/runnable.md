...
draft: true
description: "void run() task unit — functional interface for threads and executors."
...
_TODO: Explain **Runnable** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Runnable helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Thread](/java-engineering/thread/)
- [Next: Callable](/java-engineering/callable/)
