...
draft: true
description: "Flexible phased coordination — dynamic party registration."
...
_TODO: Explain **Phaser** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Phaser helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: CyclicBarrier](/java-engineering/cyclicbarrier/)
- [Next: ThreadLocal](/java-engineering/threadlocal/)
