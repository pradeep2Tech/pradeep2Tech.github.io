...
draft: true
description: "Reachability, GC roots, and collection cycles."
...
_TODO: Explain **Garbage Collection** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Garbage Collection helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Object Creation](/java-engineering/object-creation/)
- [Next: GC Algorithms](/java-engineering/gc-algorithms/)
