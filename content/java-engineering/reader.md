...
draft: true
description: "Character-oriented input — encoding-aware text."
...
_TODO: Explain **Reader** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Reader helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: OutputStream](/java-engineering/outputstream/)
- [Next: Writer](/java-engineering/writer/)
