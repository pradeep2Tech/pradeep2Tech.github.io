...
draft: true
description: "Prefer JSON/Protobuf; security and evolution rules."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Serialization Practices"
module: 14
moduleTitle: "Serialization"
sectionRef: "14.4"
ShowToc: true
...
_TODO: Explain **Serialization Best Practices** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Serialization Best Practices helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: serialVersionUID](/java-engineering/serialversionuid/)
- [Next: Collections Complexity](/java-engineering/collections-complexity/)
