...
draft: true
description: "ReentrantLock — explicit lock, tryLock, and fairness."
...
_TODO: Explain **Locks** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Locks helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Atomic Classes](/java-engineering/atomic-classes/)
- [Next: ReadWriteLock](/java-engineering/readwritelock/)
