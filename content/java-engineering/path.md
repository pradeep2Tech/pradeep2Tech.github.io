...
draft: true
description: "java.nio.file.Path — modern path abstraction."
...
_TODO: Explain **Path** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Path helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: File](/java-engineering/file/)
- [Next: Files](/java-engineering/files/)
