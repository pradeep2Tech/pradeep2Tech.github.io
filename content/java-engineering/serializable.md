...
draft: true
description: "Marker interface — default Java serialization mechanics."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Serializable"
module: 14
...
_TODO: Explain **Serializable** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Serializable helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Annotation Processing](/java-engineering/annotation-processing/)
- [Next: Externalizable](/java-engineering/externalizable/)
