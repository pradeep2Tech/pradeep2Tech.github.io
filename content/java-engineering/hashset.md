...
draft: true
description: "Hash table-backed unique elements — O(1) average add/contains."
...
_TODO: Explain **HashSet** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How HashSet helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Vector](/java-engineering/vector/)
- [Next: LinkedHashSet](/java-engineering/linkedhashset/)
