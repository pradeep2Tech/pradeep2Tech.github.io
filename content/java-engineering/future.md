...
draft: true
description: "Async result handle — get, cancel, isDone."
...
_TODO: Explain **Future** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Future helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: ForkJoinPool](/java-engineering/forkjoinpool/)
- [Next: CompletableFuture](/java-engineering/completablefuture/)
