...
draft: true
description: "Red-black tree sorted set — O(log n) ops with natural or Comparator order."
...
_TODO: Explain **TreeSet** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How TreeSet helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: LinkedHashSet](/java-engineering/linkedhashset/)
- [Next: HashMap](/java-engineering/hashmap/)
