...
draft: true
description: "Built-in collectors — toList, toMap, joining, summarizing."
...
_TODO: Explain **Collectors** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Collectors helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Terminal Ops](/java-engineering/terminal-operations/)
- [Next: Grouping](/java-engineering/grouping/)
