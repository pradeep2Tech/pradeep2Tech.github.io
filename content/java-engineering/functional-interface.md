...
draft: true
description: "@FunctionalInterface — single abstract method types for lambdas."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Functional Interface"
module: 6
...
_TODO: Explain **Functional Interface** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Functional Interface helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Type Erasure](/java-engineering/type-erasure/)
- [Next: Lambda](/java-engineering/lambda/)
