...
draft: true
description: "Compile-time enforced handling — IOException, SQLException, and subclasses."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Checked Exception"
module: 4
...
_TODO: Explain **Checked Exception** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Checked Exception helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Next: Unchecked Exception](/java-engineering/unchecked-exception/)
