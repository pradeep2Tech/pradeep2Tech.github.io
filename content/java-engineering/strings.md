...
draft: true
description: "Immutable character sequences — literals, interning, comparison, and common APIs."
...
_TODO: Explain **Strings** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Strings helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Arrays](/java-engineering/arrays/)
- [Next: StringBuilder](/java-engineering/stringbuilder/)
