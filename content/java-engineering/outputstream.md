...
draft: true
description: "Byte-oriented output — write and flush."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "OutputStream"
module: 12
moduleTitle: "Java IO"
sectionRef: "12.5"
ShowToc: true
...
_TODO: Explain **OutputStream** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How OutputStream helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: InputStream](/java-engineering/inputstream/)
- [Next: Reader](/java-engineering/reader/)
