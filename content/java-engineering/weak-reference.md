...
draft: true
description: "Collected eagerly at next GC — WeakHashMap keys."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Weak Reference"
module: 9
...
_TODO: Explain **Weak Reference** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Weak Reference helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Strong Reference](/java-engineering/strong-reference/)
- [Next: Soft Reference](/java-engineering/soft-reference/)
