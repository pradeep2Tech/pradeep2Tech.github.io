...
draft: true
description: "new, allocation, initialization order, and constructor chaining."
...
_TODO: Explain **Object Creation** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Object Creation helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: JVM Memory](/java-engineering/jvm-memory-layout/)
- [Next: Garbage Collection](/java-engineering/garbage-collection/)
