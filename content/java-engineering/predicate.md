...
draft: true
description: "boolean test(T) — filtering and conditional logic."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Predicate"
module: 6
...
_TODO: Explain **Predicate** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Predicate helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Consumer](/java-engineering/consumer/)
- [Next: Function](/java-engineering/function/)
