...
draft: true
description: "Doubly-linked list — efficient head/tail ops, poor indexed access."
...
_TODO: Explain **LinkedList** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How LinkedList helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: ArrayList](/java-engineering/arraylist/)
- [Next: Vector](/java-engineering/vector/)
