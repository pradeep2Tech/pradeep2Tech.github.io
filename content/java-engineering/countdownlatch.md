...
draft: true
description: "One-shot gate — await until count reaches zero."
...
_TODO: Explain **CountDownLatch** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How CountDownLatch helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Semaphore](/java-engineering/semaphore/)
- [Next: CyclicBarrier](/java-engineering/cyclicbarrier/)
