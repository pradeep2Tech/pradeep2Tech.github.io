...
draft: true
description: "Exception handling blocks — multi-catch and exception type ordering."
...
_TODO: Explain **try-catch** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How try-catch helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Error](/java-engineering/error/)
- [Next: finally](/java-engineering/finally/)
