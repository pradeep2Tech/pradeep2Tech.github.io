...
draft: true
description: "Upper bounds on type parameters — <T extends Comparable<T>>."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Bounded Types"
module: 5
...
_TODO: Explain **Bounded Types** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Bounded Types helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Wildcards](/java-engineering/wildcards/)
- [Next: Type Erasure](/java-engineering/type-erasure/)
