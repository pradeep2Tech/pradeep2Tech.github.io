...
draft: true
description: "Legacy synchronized resizable array — prefer ArrayList + external sync."
...
_TODO: Explain **Vector** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Vector helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: LinkedList](/java-engineering/linkedlist/)
- [Next: HashSet](/java-engineering/hashset/)
