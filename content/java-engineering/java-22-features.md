...
draft: true
description: "Stable features — unnamed variables, stream gatherers (preview)."
...
_TODO: Explain **Java 22 Features** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Java 22 Features helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Java 21 LTS](/java-engineering/java-21-features/)
- [Next: Java 23](/java-engineering/java-23-features/)
