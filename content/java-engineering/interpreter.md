...
draft: true
description: "Bytecode interpretation before JIT compilation kicks in."
...
_TODO: Explain **Interpreter** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Interpreter helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: JIT Compiler](/java-engineering/jit-compiler/)
- [Next: GC (JVM View)](/java-engineering/garbage-collector-jvm/)
