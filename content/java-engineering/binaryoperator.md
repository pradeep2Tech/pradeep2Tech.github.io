...
draft: true
description: "BiFunction<T, T, T> — reduction and aggregation."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "BinaryOperator"
module: 6
...
_TODO: Explain **BinaryOperator** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How BinaryOperator helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: UnaryOperator](/java-engineering/unaryoperator/)
- [Next: Creating Streams](/java-engineering/creating-streams/)
