...
draft: true
description: "JIT optimization — stack allocation and lock elision."
...
_TODO: Explain **Escape Analysis** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Escape Analysis helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: OutOfMemoryError](/java-engineering/outofmemoryerror/)
- [Next: JVM Architecture](/java-engineering/jvm-architecture/)
