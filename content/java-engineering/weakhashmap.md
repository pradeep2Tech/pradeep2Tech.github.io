...
draft: true
description: "Keys held by weak references — useful for caches keyed by short-lived objects."
...
_TODO: Explain **WeakHashMap** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How WeakHashMap helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: ConcurrentHashMap](/java-engineering/concurrenthashmap/)
- [Next: IdentityHashMap](/java-engineering/identityhashmap/)
