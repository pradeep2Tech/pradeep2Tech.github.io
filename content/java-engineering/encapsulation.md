...
draft: true
description: "Bundling data with controlled access via getters and setters."
...
_TODO: Explain **Encapsulation** in simple English — one short paragraph._
...
- [Previous: Abstraction](/java-engineering/abstraction/)
- [Next: Interface](/java-engineering/interface/)
