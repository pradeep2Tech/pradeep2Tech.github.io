...
draft: true
description: "Static NIO.2 utilities — read, write, walk, copy."
...
_TODO: Explain **Files** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Files helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Path](/java-engineering/path/)
- [Next: InputStream](/java-engineering/inputstream/)
