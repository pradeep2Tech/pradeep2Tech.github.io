...
draft: true
description: "Hiding implementation detail behind essential behavior."
...
_TODO: Explain **Abstraction** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Abstraction helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Polymorphism](/java-engineering/polymorphism/)
- [Next: Encapsulation](/java-engineering/encapsulation/)
