...
draft: true
description: "synchronized methods and blocks — intrinsic locks and reentrancy."
...
_TODO: Explain **Synchronization** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Synchronization helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: CompletableFuture](/java-engineering/completablefuture/)
- [Next: volatile](/java-engineering/volatile/)
