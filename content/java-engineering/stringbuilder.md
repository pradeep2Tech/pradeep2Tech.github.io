...
draft: true
description: "Mutable, non-thread-safe string builder for single-threaded concatenation."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "StringBuilder"
module: 1
...
_TODO: Explain **StringBuilder** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How StringBuilder helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Strings](/java-engineering/strings/)
- [Next: StringBuffer](/java-engineering/stringbuffer/)
