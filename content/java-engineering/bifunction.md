...
draft: true
description: "Two-argument transformation R apply(T, U)."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "BiFunction"
module: 6
...
_TODO: Explain **BiFunction** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How BiFunction helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Function](/java-engineering/function/)
- [Next: UnaryOperator](/java-engineering/unaryoperator/)
