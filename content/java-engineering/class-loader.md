...
draft: true
description: "Bootstrap, platform, application loaders and delegation model."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Class Loader"
module: 10
...
_TODO: Explain **Class Loader** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Class Loader helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: JVM Architecture](/java-engineering/jvm-architecture/)
- [Next: Class Loading](/java-engineering/class-loading-process/)
