...
draft: true
description: "Shorthand :: syntax — static, instance, and constructor references."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Method Reference"
module: 6
...
_TODO: Explain **Method Reference** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Method Reference helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Lambda](/java-engineering/lambda/)
- [Next: Optional](/java-engineering/optional/)
