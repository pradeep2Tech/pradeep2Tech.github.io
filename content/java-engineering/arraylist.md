...
draft: true
description: "Resizable array-backed list — fast random access, costly middle inserts."
...
_TODO: Explain **ArrayList** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How ArrayList helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Overview](/java-engineering/collections-framework-overview/)
- [Next: LinkedList](/java-engineering/linkedlist/)
