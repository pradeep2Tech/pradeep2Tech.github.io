...
draft: true
description: "Partial implementations — abstract methods vs concrete shared code."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Abstract Class"
module: 2
...
_TODO: Explain **Abstract Class** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Abstract Class helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Interface](/java-engineering/interface/)
- [Next: Object Class](/java-engineering/object-class/)
