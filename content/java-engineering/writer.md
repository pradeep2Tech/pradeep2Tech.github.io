...
draft: true
description: "Character-oriented output — buffering and encoding."
...
_TODO: Explain **Writer** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Writer helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Reader](/java-engineering/reader/)
- [Next: Buffered Streams](/java-engineering/buffered-streams/)
