...
draft: true
description: "Mutable, synchronized string builder — legacy thread-safe alternative."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "StringBuffer"
module: 1
...
_TODO: Explain **StringBuffer** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How StringBuffer helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: StringBuilder](/java-engineering/stringbuilder/)
- [Next: Enums](/java-engineering/enums/)
