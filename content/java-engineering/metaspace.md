...
draft: true
description: "Class metadata storage replacing PermGen since Java 8."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Metaspace"
module: 9
...
_TODO: Explain **Metaspace** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Metaspace helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Old Gen](/java-engineering/old-generation/)
- [Next: Reference Types](/java-engineering/reference-types/)
