...
draft: true
description: "Root of the class hierarchy — universal methods every type inherits."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Object Class"
module: 2
...
_TODO: Explain **Object Class** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Object Class helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Abstract Class](/java-engineering/abstract-class/)
- [Next: equals()](/java-engineering/equals-method/)
