...
draft: true
description: "Natural ordering vs external comparison strategies."
...
_TODO: Explain **Comparable vs Comparator** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Comparable vs Comparator helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Arrays](/java-engineering/arrays-util/)
