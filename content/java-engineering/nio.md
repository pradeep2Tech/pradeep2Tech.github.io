...
draft: true
description: "Channels, buffers, selectors — non-blocking IO overview."
...
_TODO: Explain **NIO** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How NIO helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Serialization IO](/java-engineering/serialization-basics-io/)
- [Next: Reflection](/java-engineering/reflection-api/)
