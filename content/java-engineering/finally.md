...
draft: true
description: "Guaranteed cleanup — runs after try/catch even when return or throw."
...
_TODO: Explain **finally** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How finally helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: try-catch](/java-engineering/try-catch/)
- [Next: try-with-resources](/java-engineering/try-with-resources/)
