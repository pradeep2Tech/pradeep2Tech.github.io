...
draft: true
description: "HotSpot C1/C2 — profiling, inlining, and deoptimization."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "JIT Compiler"
module: 10
...
_TODO: Explain **JIT Compiler** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How JIT Compiler helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Bytecode](/java-engineering/bytecode/)
- [Next: Interpreter](/java-engineering/interpreter/)
