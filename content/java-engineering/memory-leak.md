...
draft: true
description: "Retained unreachable objects — static collections, listeners, ThreadLocal."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Memory Leak"
module: 9
...
_TODO: Explain **Memory Leak** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Memory Leak helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Phantom Reference](/java-engineering/phantom-reference/)
- [Next: OutOfMemoryError](/java-engineering/outofmemoryerror/)
