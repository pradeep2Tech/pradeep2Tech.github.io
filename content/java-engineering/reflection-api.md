...
draft: true
description: "Runtime class introspection — fields, methods, constructors."
...
_TODO: Explain **Reflection API** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Reflection API helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: NIO](/java-engineering/nio/)
- [Next: Custom Annotation](/java-engineering/custom-annotation/)
