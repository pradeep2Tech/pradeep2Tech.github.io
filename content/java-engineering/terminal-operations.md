...
draft: true
description: "Eager consumers — collect, reduce, forEach, count, findFirst."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Terminal Ops"
module: 7
...
_TODO: Explain **Terminal Operations** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Terminal Operations helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Intermediate Ops](/java-engineering/intermediate-operations/)
- [Next: Collectors](/java-engineering/collectors/)
