...
draft: true
description: "Permit-based throttling — bounded resource access."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Semaphore"
module: 8
...
_TODO: Explain **Semaphore** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Semaphore helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: ReadWriteLock](/java-engineering/readwritelock/)
- [Next: CountDownLatch](/java-engineering/countdownlatch/)
