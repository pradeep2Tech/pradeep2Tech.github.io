...
draft: true
description: "void accept(T) — side-effect operations on a value."
...
_TODO: Explain **Consumer** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Consumer helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Supplier](/java-engineering/supplier/)
- [Next: Predicate](/java-engineering/predicate/)
