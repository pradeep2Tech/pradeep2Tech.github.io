...
draft: true
description: "java launcher, classpath, module path, and main class loading."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "JVM Startup"
module: 10
...
_TODO: Explain **JVM Startup** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How JVM Startup helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: GC (JVM View)](/java-engineering/garbage-collector-jvm/)
- [Next: JVM Parameters](/java-engineering/jvm-parameters/)
