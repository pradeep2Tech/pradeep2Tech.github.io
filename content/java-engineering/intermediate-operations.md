...
draft: true
description: "Lazy transforms — filter, map, flatMap, sorted, distinct."
tags: ["java", "java-cheatsheet", "handbook"]
categories: ["Java Engineering Handbook"]
shortTitle: "Intermediate Ops"
module: 7
...
_TODO: Explain **Intermediate Operations** in simple English — one short paragraph._

---

## Why It Exists

| Problem | How Intermediate Operations helps |
| :--- | :--- |
| _TODO_ | _TODO_ |
...
- [Previous: Creating Streams](/java-engineering/creating-streams/)
- [Next: Terminal Ops](/java-engineering/terminal-operations/)
